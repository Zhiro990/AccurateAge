<script>
	...
	function Change() {
		...
		info.innerHTML = `${years} year${years > 1 ? "s" : ""}, ${months} month${months > 1 ? "s" : ""}, ${days} day${days > 1 ? "s" : ""}`;
...
<div
	class="w-fit h-auto mt-[25px] mx-auto"
>
	...
	<div
		class="w-full h-auto bg-[#303742] px-[20px] py-[10px] rounded-b-lg"
	>
